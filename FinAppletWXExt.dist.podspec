Pod::Spec.new do |s|
  ...
  s.version      = "2.39.0-alpha20221124v10"
  ...
  s.source       = { :http => "https://app.finogeeks.com/finchat/sdk/FinAppletWXExt-dev-2.39.0-alpha20221124v10.zip"  }
  s.vendored_frameworks = "FinAppletWXExt.framework" 
  s.requires_arc = true
  s.libraries = 'c++'
  s.dependency 'FinApplet','2.39.0-alpha20221124v10'
