Pod::Spec.new do |s|
  ...
  s.version      = "2.40.0-alpha20230210v02"
  ...
  s.source       = { :http => "https://app.finogeeks.com/finchat/sdk/FinAppletWXExt-dev-2.40.0-alpha20230210v02.zip"  }
  s.vendored_frameworks = "FinAppletWXExt.framework" 
  s.requires_arc = true
  s.libraries = 'c++'
  s.dependency 'FinApplet','2.40.0-alpha20230210v02'
