Pod::Spec.new do |s|
  ...
  s.version      = "3.38.8-alpha20221126v01"
  ...
  s.source       = { :http => "https://app.finogeeks.com/finchat/sdk/FinAppletWXExt-dev-3.38.8-alpha20221126v01.zip"  }
  s.vendored_frameworks = "FinAppletWXExt.framework" 
  s.requires_arc = true
  s.libraries = 'c++'
  s.dependency 'FinApplet','3.38.8-alpha20221126v01'
