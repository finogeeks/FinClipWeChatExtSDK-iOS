Pod::Spec.new do |s|
  ...
  s.version      = "2.42.10-dev20231211v01"
  ...
  s.source       = { :http => "https://app.finogeeks.com/finchat/sdk/FinAppletWXExt-dev-2.42.10-dev20231211v01.zip"  }
  s.vendored_frameworks = "FinAppletWXExt.framework" 
  s.requires_arc = true
  s.libraries = 'c++'
  s.dependency 'FinApplet','2.42.10-dev20231211v01'
