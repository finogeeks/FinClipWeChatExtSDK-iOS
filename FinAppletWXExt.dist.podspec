Pod::Spec.new do |s|
  ...
  s.version      = "2.50.0-dev20251017v04"
  ...
  s.source       = { :http => "https://app.finogeeks.com/finchat/sdk/FinAppletWXExt-2.50.0-dev20251017v04.zip"  }
  s.vendored_frameworks = "FinAppletWXExt.xcframework" 
  s.requires_arc = true
  s.libraries = 'c++'
  s.dependency 'FinApplet','2.50.0-dev20251017v04'
