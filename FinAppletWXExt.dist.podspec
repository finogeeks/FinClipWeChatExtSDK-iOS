Pod::Spec.new do |s|
  ...
  s.version      = "2.43.3-alpha20240204v03"
  ...
  s.source       = { :http => "https://app.finogeeks.com/finchat/sdk/FinAppletWXExt-2.43.3-alpha20240204v03.zip"  }
  s.vendored_frameworks = "FinAppletWXExt.framework" 
  s.requires_arc = true
  s.libraries = 'c++'
  s.dependency 'FinApplet','2.43.3-alpha20240204v03'
