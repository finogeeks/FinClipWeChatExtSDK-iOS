Pod::Spec.new do |s|
  ...
  s.version      = "2.48.0-dev20250418v07"
  ...
  s.source       = { :http => "https://app.finogeeks.com/finchat/sdk/FinAppletWXExt-2.48.0-dev20250418v07.zip"  }
  s.vendored_frameworks = "FinAppletWXExt.framework" 
  s.requires_arc = true
  s.libraries = 'c++'
  s.dependency 'FinApplet','2.48.0-dev20250418v07'
