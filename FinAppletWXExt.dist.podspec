Pod::Spec.new do |s|
  ...
  s.version      = "38.0-alpha20220901v07"
  ...
  s.source       = { :http => "https://app.finogeeks.com/finchat/sdk/FinAppletWXExt-dev-38.0-alpha20220901v07.zip"  }
  s.vendored_frameworks = "FinAppletWXExt.framework" 
  s.requires_arc = true
  s.libraries = 'c++'
  s.dependency 'FinApplet','38.0-alpha20220901v07'
