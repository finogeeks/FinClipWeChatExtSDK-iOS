Pod::Spec.new do |s|
  ...
  s.version      = "2.43.5-dev20240223v02"
  ...
  s.source       = { :http => "https://app.finogeeks.com/finchat/sdk/FinAppletWXExt-dev-2.43.5-dev20240223v02.zip"  }
  s.vendored_frameworks = "FinAppletWXExt.framework" 
  s.requires_arc = true
  s.libraries = 'c++'
  s.dependency 'FinApplet','2.43.5-dev20240223v02'
