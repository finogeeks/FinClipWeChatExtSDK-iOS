Pod::Spec.new do |s|
  ...
  s.version      = "2.48.6-dev20250605v04"
  ...
  s.source       = { :http => "https://app.finogeeks.com/finchat/sdk/FinAppletWXExt-2.48.6-dev20250605v04.zip"  }
  s.vendored_frameworks = "FinAppletWXExt.framework" 
  s.requires_arc = true
  s.libraries = 'c++'
  s.dependency 'FinApplet','2.48.6-dev20250605v04'
