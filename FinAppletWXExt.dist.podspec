Pod::Spec.new do |s|
  ...
  s.version      = "2.43.8-dev20230304v06"
  ...
  s.source       = { :http => "https://app.finogeeks.com/finchat/sdk/FinAppletWXExt-2.43.8-dev20230304v06.zip"  }
  s.vendored_frameworks = "FinAppletWXExt.framework" 
  s.requires_arc = true
  s.libraries = 'c++'
  s.dependency 'FinApplet','2.43.8-dev20230304v06'
