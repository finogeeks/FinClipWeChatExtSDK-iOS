Pod::Spec.new do |s|
  ...
  s.version      = "2.40.4-dev20230419v07"
  ...
  s.source       = { :http => "https://app.finogeeks.com/finchat/sdk/FinAppletWXExt-dev-2.40.4-dev20230419v07.zip"  }
  s.vendored_frameworks = "FinAppletWXExt.framework" 
  s.requires_arc = true
  s.libraries = 'c++'
  s.dependency 'FinApplet','2.40.4-dev20230419v07'
