Pod::Spec.new do |s|
  ...
  s.version      = "2.44.6-dev20240522v03"
  ...
  s.source       = { :http => "https://app.finogeeks.com/finchat/sdk/FinAppletWXExt-2.44.6-dev20240522v03.zip"  }
  s.vendored_frameworks = "FinAppletWXExt.framework" 
  s.requires_arc = true
  s.libraries = 'c++'
  s.dependency 'FinApplet','2.44.6-dev20240522v03'
