Pod::Spec.new do |s|
  ...
  s.version      = "2.43.0-dev20240105v08"
  ...
  s.source       = { :http => "https://app.finogeeks.com/finchat/sdk/FinAppletWXExt-dev-2.43.0-dev20240105v08.zip"  }
  s.vendored_frameworks = "FinAppletWXExt.framework" 
  s.requires_arc = true
  s.libraries = 'c++'
  s.dependency 'FinApplet','2.43.0-dev20240105v08'
