Pod::Spec.new do |s|
  ...
  s.version      = "2.38.0-alpha20220908v06"
  ...
  s.source       = { :http => "https://app.finogeeks.com/finchat/sdk/FinAppletWXExt-dev-2.38.0-alpha20220908v06.zip"  }
  s.vendored_frameworks = "FinAppletWXExt.framework" 
  s.requires_arc = true
  s.libraries = 'c++'
  s.dependency 'FinApplet','2.38.0-alpha20220908v06'
