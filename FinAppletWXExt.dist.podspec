Pod::Spec.new do |s|
  ...
  s.version      = "2.41.6-dev20230810v04"
  ...
  s.source       = { :http => "https://app.finogeeks.com/finchat/sdk/FinAppletWXExt-dev-2.41.6-dev20230810v04.zip"  }
  s.vendored_frameworks = "FinAppletWXExt.framework" 
  s.requires_arc = true
  s.libraries = 'c++'
  s.dependency 'FinApplet','2.41.6-dev20230810v04'
