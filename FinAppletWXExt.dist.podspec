Pod::Spec.new do |s|
  ...
  s.version      = "2.38.4-alpha20221027v16"
  ...
  s.source       = { :http => "https://app.finogeeks.com/finchat/sdk/FinAppletWXExt-dev-2.38.4-alpha20221027v16.zip"  }
  s.vendored_frameworks = "FinAppletWXExt.framework" 
  s.requires_arc = true
  s.libraries = 'c++'
  s.dependency 'FinApplet','2.38.4-alpha20221027v16'
