Pod::Spec.new do |s|
  ...
  s.version      = "2.42.2-dev20231019v04"
  ...
  s.source       = { :http => "https://app.finogeeks.com/finchat/sdk/FinAppletWXExt-dev-2.42.2-dev20231019v04.zip"  }
  s.vendored_frameworks = "FinAppletWXExt.framework" 
  s.requires_arc = true
  s.libraries = 'c++'
  s.dependency 'FinApplet','2.42.2-dev20231019v04'
