Pod::Spec.new do |s|
  ...
  s.version      = "2.44.4-dev20240514v02"
  ...
  s.source       = { :http => "https://app.finogeeks.com/finchat/sdk/FinAppletWXExt-2.44.4-dev20240514v02.zip"  }
  s.vendored_frameworks = "FinAppletWXExt.framework" 
  s.requires_arc = true
  s.libraries = 'c++'
  s.dependency 'FinApplet','2.44.4-dev20240514v02'
