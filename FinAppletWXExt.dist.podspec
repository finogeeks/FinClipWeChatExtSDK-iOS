Pod::Spec.new do |s|
  ...
  s.version      = "2.41.0-dev20230601v13"
  ...
  s.source       = { :http => "https://app.finogeeks.com/finchat/sdk/FinAppletWXExt-dev-2.41.0-dev20230601v13.zip"  }
  s.vendored_frameworks = "FinAppletWXExt.framework" 
  s.requires_arc = true
  s.libraries = 'c++'
  s.dependency 'FinApplet','2.41.0-dev20230601v13'
